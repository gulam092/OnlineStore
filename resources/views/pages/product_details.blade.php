...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-2 order-lg-1 order-2">
			<ul class="image_list">
				<li data-image="{{asset($product->image_one)}}"><img src="{{asset($product->image_two)}}" alt=""></li>
...
<div class="col-lg-5 order-3">
 <div class="product_description">
			 ...
			 {!!  str_limit($product->product_details, $limit = 400 )  !!}</p></div>
		 	...
		 	<div class="col-lg-4">
		 		<div class="form-group">
		 			...
		 			<select class="form-control " id="exampleFormcolor" name="size">
 ...
 @else
		 	<div class="col-lg-4">
		 		<div class="form-group">
		 			...
		 			<select class="form-control input-lg" id="exampleFormControlsize" name="size">Select 
     ...
     @endif
			...
			<div class="button_container">
              ...
              <br><br>
                ...
                <div class="addthis_inline_share_toolbox_lrqr"></div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/hi_IN/sdk.js#xfbml=1&version=v7.0">
</script>

<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5ed38dbe87eb7962"></script>
