            ...
            <div class="available">
                <div class="available_line d-flex flex-row justify-content-start">
                    <div class="available_title">Available: 
                        {{$ht->product_quantity}}<span></span></div>
...
<div class="product_panel panel active">
    ...
    <div class="product_name"><div><a href="{{url('product/details/'.$row->id.'/'.$row->product_name)}}">{{$row->product_name}}</a></div></div>
          ...
          <div class="product_extras">
                <button id ="{{ $row->id }}"class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" 
...
<div class="row fill_height">
    <div class="col-lg-4 col-md-6 fill_height">
        <div class="banner_2_content">
            <div class="banner_2_category"><h4>{{$row->category_name}}
            </h4></div>
            <div class="banner_2_title"><h4>{{$row->product_name}}
            </h4></div>
            <div class="banner_2_text"><h4>{{$row->brand_name}}</h4>
            <br>
...
$product = DB::table('products')->where('category_id',$catid)
           ->where('status',1)->limit(10)->orderBy('id','DESC')->get();
      ...
      <div class="col">
        <div class="tabbed_container">
         <div class="tabs clearfix tabs-right">
          <div class="new_arrivals_title">{{ $cats->category_name }}
        </div>
          <ul class="clearfix">
              <li class="active"> </li>
...
{{--$cats = DB::table('categories')->skip(9)->first();--}}
@php
$cats = DB::table('categories')->skip(9)->first();
$catid = $cats->id;
$product = DB::table('products')->where('category_id',$catid)
...
<div class="trends_container">
    ...
    <div class="trends_text"><p>"Buy one, get one free" or "two for the price of one" is a common form of sales promotion.</p></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4">
            <div class="card">
              <img src="" class="text-center" id ="pimage" style="height: 220px; width: 200px;">
              <div class="card-body">
                <h5 class="card-t" id ="pname"></h5>
              </div>
            </div>
          </div>
  <div class="col-md-4">
