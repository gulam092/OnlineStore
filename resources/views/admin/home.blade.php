...
$today  =DB::table('orders')->where('date',$date)
         ->where('status',3)->sum('total');

$return  =DB::table('orders')->where('return_order',2)
          ->sum('total');   
        ...
        <div class="row row-sm">
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card pd-20 bg-sl-primary">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold">${{$year}}
                </h3>
              </div><!-- card-body -->
...
<div class="row row-sm">
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card pd-20 bg-sl-primary">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{count($users)}}
                </h3>
              </div><!-- card-body -->
