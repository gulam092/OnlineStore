 ...
 <a href="{{ route('all.blogpost')}}" class="btn btn-success btn-sm pull-right"> All Post</a>
      ...
      <form method="post" action="{{ url('update/post/'.$post->id) }}" enctype="multipart/form-data">   
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Update Post Title (ENGLISH): <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="post_title_en" value="{{$post->post_title_in}}">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label"> Update Post Title (HINDI): <span class="tx-danger">*</span></label>
       ...
       <select class="form-control select2" data-placeholder="Choose country" name="category_id">
                    ...
                    <?php endif ?>>{{ $row->category_name_en }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
