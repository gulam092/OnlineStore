...
<!-- Datatable css -->
 ...
 @else
  <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> ecomm</a></div>
 ...
 @if(Auth::user()->other==1)
        ...
        <ul class="sl-menu-sub nav flex-column">
         ...
         <li class="nav-item"><a href="{{route('admin.seo')}}" 
            class="nav-link">SEO Setting</a></li>
      </ul>
       @else
    @endif
       @if(Auth::user()->report==1)
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('today.order')}}" 
            class="nav-link">Today Order</a></li>
         <li class="nav-item"><a href="{{route('today.delivery')}}" 
            class="nav-link">Today Delivery</a></li>
    ...
    @endif
     @if(Auth::user()->role==1)
       <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('create.admin')}}" 
            class="nav-link">Crete user</a></li>
         <li class="nav-item"><a href="{{route('admin.all.user')}}" 
            class="nav-link">all user</a></li>
       </ul>
       @else
    @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.return.request')}}" 
            class="nav-link">Return request</a></li>
        <li class="nav-item"><a href="{{route('admin.all.return')}}" 
            class="nav-link">all Return</a></li>
       </ul>
  @else
    @endif
      ...
      @if(Auth::user()->stock==1)
       <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.product.stock')}}" 
            class="nav-link"> Stock</a></li>
    ...
    @endif 
       ...
       <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
         ...
         <li class="nav-item"><a href="{{route('contact.message')}}" 
            class="nav-link">all Message</a></li>
       </ul>
          @else
    @endif 
     ...
     <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="" 
            class="nav-link">New comment</a></li>
         <li class="nav-item"><a href="" 
            class="nav-link">all comment</a></li>
       </ul>
        @else
    @endif
    ...
    <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.site.setting')}}" 
            class="nav-link">Site Setting</a></li>
