...
<div class="row">
    <div class="col d-flex flex-row">
        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('public/frontend/images/phone.png')}}" alt=""></div>+91{{$setting->phone_one}}</div>
            ...
            <div class="top_bar_menu">
                ...
                @endphp
                    <li>
                       ...
                       @else
                  <li> <a href="{{route('language.Hindi')}}">Hindi<i class="fas fa-chevron-down"></i> </a></li>
                       @endif            
...
<div class="row">
    ...
    <div class="col-lg-2 col-sm-3 col-3 order-1">
        <div class="logo_container">
            <div class="logo"><a href="{{url('/')}}"><img src="{{asset('public/frontend/logo.png')}}" alt=""></a></div>
        </div>
    </div>
...
<div class="footer_phone">+91{{$setting->phone_two}}</div>
...
<ul>
    <li><a href="{{$setting->facebook}}"><i class="fab fa-facebook-f">
    </i></a></li>
    <li><a href="{{$setting->twitter}}"><i class="fab fa-twitter"></i></a></li>
    <li><a href="{{$setting->youtube}}"><i class="fab fa-youtube"></i></a></li>
    <li><a href="{{$setting->google}}"><i class="fab fa-google"></i></a></li>
      ...
      <div class="modal-body">
        <form  method="POST" action="{{route('order.tracking')}}">
          ...
          <div class="modal-body">
            ...
            <input type="text" name="code" required="" class="form-control" placeholder="your order code">
          </div>
          <button class="btn btn-danger" type="submit">track now
          </button>
        </form>
      </div>
         ...
         $(document).on("click", "#return", function(e){
             ...
             var link = $(this).attr("href");
                swal({
                  ...
                  text: "Once Return, This will be sure Return your money!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
